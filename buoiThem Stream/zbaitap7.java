...
//        Bài 7: Tổng độ dài tên của nhân viên giỏi toàn diện
//        Yêu cầu:
//        Chọn người vừa trẻ (tuổi < 28) vừa có lương > 1500
//        Tính tổng độ dài tên của họ (map + sum)

        int result = employeeList
                .stream()
                .filter(i -> i.getAge() < 28 && i.getSalary() > 1500)
